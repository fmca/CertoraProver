TACSymbolTable {
	...
	R35:bv256:17
	R43:bv256:15
	CANON25!4:ghostmap(bv256*bv256*bv256->bv256):18
	...
	CANON22:int
	CANON23:int
	CANON25:ghostmap(bv256*bv256*bv256->bv256):18
	CANON26:bv256:15
	CANON39:bv256:15
	CANON40:bv256:15
	CANON41:bv256:15
	...
	lastHasThrown!!23:bool:26
	lastHasThrown!!36:bool:26
...
Program {
	Block 0_0_0_0_0_0 Succ [1_0_0_1_0_0] {
		...
		AssumeExpCmd LAnd(Ge(CANON11:20 0x0(int) ) Le(CANON11:20 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		...
		AssumeExpCmd LAnd(Ge(CANON14:23 0x0(int) ) Le(CANON14:23 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON25!4:18
		...
		AssignHavocCmd CANON4:27
		AssumeExpCmd LAnd(Ge(CANON4:27 0x0(int) ) Le(CANON4:27 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON5:28
		AssumeExpCmd Eq(CANON5:28 0x0(int) )
		AssignHavocCmd CANON6:29
		AssumeExpCmd LAnd(Ge(CANON6:29 0x0(int) ) Le(CANON6:29 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON7:30
		AssumeExpCmd LAnd(Ge(CANON7:30 0x0(int) ) Le(CANON7:30 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON8:31
		AssumeExpCmd LAnd(Ge(CANON8:31 0x0(int) ) Le(CANON8:31 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON9:32
		AssumeExpCmd LAnd(Ge(CANON9:32 0x0(int) ) Le(CANON9:32 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		...
		AnnotationCmd:37 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"contract address vars initialized"}}
		AssignExpCmd CANON:33 R8:38
		...
		AssignExpCmd R10:15 Select(tacExtcodesize!!2:5 Apply(to_skey:bif R8:38) )
		AssumeExpCmd Ge(R10:15 0x1 )
		AssumeExpCmd Eq(R10:42 R1:43 )
		...
		AnnotationCmd:58 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":19}
		...
		AssignExpCmd:60 I13 CANON14:23
		AssignExpCmd:61 I14 0x2
		AssignExpCmd:62 I15 IntMul(0x2(int) I13)
		AssignExpCmd:63 CANON18:24 I15
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"certoraArg243244"},"src":{"id":"e167"}}}
		AssignExpCmd:65 I17 CANON14:23
		AssignExpCmd:66 I18 0x2
		AssignExpCmd:67 I19 IntMul(0x2(int) I17)
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I19","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Const","value":"1","tag":{"#class":"tac.Tag.Bool"}},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":26,"charByteOffset":9},"end":{"line":26,"charByteOffset":34}}}}
		AssertCmd:69 true "Cast safety of toCast * 2 (mathint) to uint256 (Cast.spec:27:10)"
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
	}
	Block 1_0_0_1_0_0 Succ [2_0_0_0_0_0] {
		AnnotationCmd:68 JSON{"key":{"name":"call.trace.push","type":"analysis.icfg.Inliner$CallStack$PushRecord","erasureStrategy":"Canonical"},"value":{"callee":{"contractId":"ce4604a0000000000000000000000001","sigHash":{"n":"b3de648b"},"attr":{"#class":"scene.MethodAttribute.Common"}},"summary":null,"convention":{"#class":"analysis.icfg.Inliner.CallConventionType.FromCVL"},"calleeId":1}}
		AssignHavocCmd:68 tacCalldatasize!!21:6
		AssumeExpCmd Eq(tacCalldatasize!!21:6 0x24 )
		AssignExpCmd:68 tacCalldatabuf@1:9 MapDefinition(CANON24.577:bv256 -> Ite(Lt(CANON24.577 tacCalldatasize!!21:6 ) Select(Select(Select(CANON25!4:18 CANON24.577 ) tacCalldatasize!!21:6 ) 0xb3de648b ) 0x0 ) bytemap)
		AssignExpCmd:68 R22:15 Select(Select(Select(CANON25!4:18 0x0 ) 0x24 ) 0xb3de648b )
		...
		AnnotationCmd:68 JSON{"key":{"name":"cvl.arg-serialization.start","type":"spec.CVLInvocationCompiler$StartSerializationMarker","erasureStrategy":"Canonical"},"value":{"id":0,"callId":1}}
		LabelCmd:68 "0: Read primitive from certoraArg245246:int..."
		AssertCmd:70 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssertCmd:70 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:68 tacCalldatabufCANON0@1:71 Apply(safe_math_narrow_bv256:bif I19)
		LabelCmd:68 "...done 0"
		...
		AnnotationCmd:68 JSON{"key":{"name":"cvl.arg-serialization.end","type":"spec.CVLInvocationCompiler$EndSerializationMarker","erasureStrategy":"Canonical"},"value":{"id":0,"callId":1}}
		AssignExpCmd:68 lastHasThrown!!23:26 false
		...
		LabelCmd "←"
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.BranchSnippet.StartBranchSnippet","branchIndex":0,"branchSource":{"range":{"specFile":"Cast.sol","start":{"line":2,"charByteOffset":0},"end":{"line":8,"charByteOffset":1}},"content":"contract Cast {...}"}}}
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.BranchSnippet.EndBranchSnippet","branchIndex":0}}
		...
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.BranchSnippet.StartBranchSnippet","branchIndex":1,"branchSource":{"range":{"specFile":"Cast.sol","start":{"line":4,"charByteOffset":4},"end":{"line":6,"charByteOffset":5}},"content":"compiler-generate condition in function f(uint a) public returns (uint256) "}}}
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.BranchSnippet.EndBranchSnippet","branchIndex":1}}
		...
		AssignExpCmd:88 R34:16 tacCalldatabufCANON0@1:89
		...
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.EVMFunctionReturnWrite","returnbufOffset":"0","returnValueSym":{"#class":"vc.data.TACSymbol.Const","value":"3"},"callIndex":1}}
		...
		AssignExpCmd:91 lastHasThrown!!36:26 false
		AssignExpCmd:91 lastReverted:4 false
		AnnotationCmd:91 JSON{"key":{"name":"tac.return.path","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
		AnnotationCmd:68 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.HaltSnippet.Return","range":{"specFile":"Cast.sol","start":{"line":4,"charByteOffset":4},"end":{"line":6,"charByteOffset":5}}}}
		LabelCmd:68 "End procedure Cast-f(uint256)"
		AnnotationCmd:68 JSON{"key":{"name":"call.trace.pop","type":"analysis.icfg.Inliner$CallStack$PopRecord","erasureStrategy":"Canonical"},"value":{"callee":{"contractId":"ce4604a0000000000000000000000001","sigHash":{"n":"b3de648b"},"attr":{"#class":"scene.MethodAttribute.Common"}},"calleeId":1}}
	}
	Block 2_0_0_0_0_0 Succ [3_0_0_2_0_0] {
		AnnotationCmd JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.StorageGlobalChangeSnippet.StorageTakeSnapshot","lhs":{"namePrefix":"lastStorage","tag":{"#class":"tac.Tag.BlockchainState"},"callIndex":0,"meta":[{"key":{"name":"cvl.def.site","type":"spec.CVLDefinitionSite","erasureStrategy":"Canonical"},"value":{"#class":"spec.CVLDefinitionSite.Rule"}},{"key":{"name":"Tac.symbol.keyword","type":"vc.data.TACSymbol$Var$KeywordEntry","erasureStrategy":"Canonical"},"value":{"#class":"vc.data.TACSymbol.Var.KeywordEntry.NonTACKeywordEntry","name":"lastStorage"}},{"key":{"name":"cvl.type","type":"spec.cvlast.CVLType$PureCVLType","erasureStrategy":"CallTrace"},"value":{"#class":"spec.cvlast.CVLType.PureCVLType.VMInternal.BlockchainState"}},{"key":{"name":"cvl","type":"java.lang.Boolean","erasureStrategy":"Canonical"},"value":true},{"key":{"name":"cvl.display","type":"java.lang.String","erasureStrategy":"CallTrace"},"value":"lastStorage"}]}}}
		AnnotationCmd:68 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":21}
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"certoraArg390391"},"src":{"id":"e167"}}}
		AssignExpCmd:93 I37 CANON14:23
		AssignExpCmd:94 I38 0x3
		AssignExpCmd:95 I39 IntMul(0x3(int) I37)
		AssignExpCmd:96 B40 Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I39 )
		AnnotationCmd:96 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I39","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B40","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":27,"charByteOffset":21},"end":{"line":27,"charByteOffset":46}}}}
		AssertCmd:97 B40 "Cast safety of toCast * 3 (mathint) to uint256 (Cast.spec:28:22)"
		AnnotationCmd:96 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
	}
	Block 3_0_0_2_0_0 Succ [] {
		AssignHavocCmd:96 CANON53:25
		AnnotationCmd:96 JSON{"key":{"name":"call.trace.push","type":"analysis.icfg.Inliner$CallStack$PushRecord","erasureStrategy":"Canonical"},"value":{"callee":{"contractId":"ce4604a0000000000000000000000001","sigHash":{"n":"b3de648b"},"attr":{"#class":"scene.MethodAttribute.Common"}},"summary":null,"convention":{"#class":"analysis.icfg.Inliner.CallConventionType.FromCVL"},"calleeId":2}}
		AssignHavocCmd:96 tacCalldatasize!!42:6
		AssignExpCmd:96 tacCalldatabuf@2:10 MapDefinition(CANON54.578:bv256 -> Ite(Lt(CANON54.578 tacCalldatasize!!42:6 ) Select(Select(Select(CANON25!4:18 CANON54.578 ) tacCalldatasize!!42:6 ) 0xb3de648b ) 0x0 ) bytemap)
		AssignExpCmd:96 R43:15 Select(Select(Select(CANON25!4:18 0x0 ) tacCalldatasize!!42:6 ) 0xb3de648b )
		...
		AnnotationCmd:96 JSON{"key":{"name":"cvl.arg-serialization.start","type":"spec.CVLInvocationCompiler$StartSerializationMarker","erasureStrategy":"Canonical"},"value":{"id":1,"callId":2}}
		LabelCmd:96 "2: Read primitive from certoraArg393394:int..."
		AssignExpCmd:96 B44 Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I39 )
		AssertCmd:98 B44 "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:96 B45 Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I39 )
		AssertCmd:98 B45 "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
	}
}
Axioms {
}
