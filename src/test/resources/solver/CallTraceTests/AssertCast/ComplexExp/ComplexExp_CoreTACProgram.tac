...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssumeExpCmd LAnd(Ge(CANON4:16 0x0(int) ) Le(CANON4:16 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		...
		AssignHavocCmd CANON6:18
		AssumeExpCmd LAnd(Ge(CANON6:18 0x0(int) ) Le(CANON6:18 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON7:19
		AssumeExpCmd LAnd(Ge(CANON7:19 0x0(int) ) Le(CANON7:19 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON8!!9:5
		AssumeExpCmd LAnd(Ge(CANON8!!9:5 0x0(int) ) Le(CANON8!!9:5 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R10:14
		AssumeExpCmd LAnd(Ge(R10:14 0x1 ) Le(R10:14 0xffffffffffffffffffffffffffffffffffffffff ) )
		AssignHavocCmd tacSCANON0!!11:4
		...
		AssignExpCmd R12:13 Select(tacExtcodesize!!3:3 Apply(to_skey:bif R10:25) )
		AssumeExpCmd Ge(R12:13 0x1 )
		AssumeExpCmd Eq(R12:29 R0:30 )
		...
		AssignExpCmd B14:13 Eq(Select(tacExtcodesize!!3:3 Apply(skey_basic:bif 0x0) ) 0x0 )
		AssumeCmd B14:13
		...
		AnnotationCmd:49 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":21}
		...
		AssignExpCmd:62 I21 CANON5:17
		AssignExpCmd:63 I22 CANON6:18
		AssignExpCmd:64 I23 IntAdd(I21 I22)
		AssignExpCmd:65 I24 CANON7:19
		AssignExpCmd:66 I25 IntSub(I23 I24 )
		AssignExpCmd:67 B26 LAnd(Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I25 ) Le(0x0 I25 ) )
		AnnotationCmd:67 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I25","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B26","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":12,"charByteOffset":13},"end":{"line":12,"charByteOffset":52}}}}
		AssertCmd:68 B26 "Cast safety of sumOld + newVal - oldVal (mathint) to uint256 (Cast.spec:13:14)"
		AnnotationCmd:67 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
		AssignExpCmd:67 CANON8!!27:5 I25
		AnnotationCmd:67 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":24}
		...
		AssignExpCmd:70 B28 false
		AssertCmd:71 false "\"require isn't vacuous\""
	}
}
Axioms {
}
