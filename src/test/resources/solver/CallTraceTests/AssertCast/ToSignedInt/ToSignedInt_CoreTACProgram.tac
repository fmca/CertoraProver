...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssignHavocCmd CANON4:7
		AssumeExpCmd LAnd(Ge(CANON4:7 0x0(int) ) Le(CANON4:7 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R5:6
		...
		AnnotationCmd:9 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"rule parameters setup"}}
		...
		AssignExpCmd R6:2 Select(tacExtcodesize!!1:1 Apply(to_skey:bif R5:13) )
		AssumeExpCmd Ge(R6:2 0x1 )
		AssumeExpCmd Eq(R6:17 R0:18 )
		...
		AssignExpCmd:33 I9 CANON4:7
		AssignExpCmd:34 B10 Ge(0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) I9 )
		AnnotationCmd:34 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I9","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B10","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":19,"charByteOffset":11},"end":{"line":19,"charByteOffset":31}}}}
		AssertCmd:35 B10 "Cast safety of toCast (uint256) to int256 (Cast.spec:20:12)"
		AnnotationCmd:34 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
	}
}
Axioms {
}
