...
Program {
	Block 0_0_0_0_0_0 Succ [1_0_0_1_0_1] {
		...
		AssumeExpCmd LAnd(Ge(CANON12:11 0x0(int) ) Le(CANON12:11 0xff(int) ) )
		...
		AssumeExpCmd LAnd(Ge(CANON9:28 0x0(int) ) Le(CANON9:28 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R6:7
		...
		AssignHavocCmd CANON:29
		AssumeExpCmd LAnd(Ge(CANON:29 0x0(int) ) Le(CANON:29 0x2(int) ) )
		...
		AssignExpCmd CANON1:26 R6:33
		AnnotationCmd JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":2}
		AnnotationCmd:34 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"contract address vars initialized"}}
		AssignExpCmd CANON2:27 R6:33
		...
		AssignExpCmd R7:3 Select(tacExtcodesize!!1:2 Apply(to_skey:bif R6:33) )
		AssumeExpCmd Ge(R7:3 0x1 )
		AssumeExpCmd Eq(R7:38 R0:39 )
		...
		AssignExpCmd:52 I10 CANON:29
		AssignExpCmd:53 I11 0x3
		AssignExpCmd:54 B12 true
	...
	Block 1_0_0_1_0_1 Succ [2_0_0_0_0_0] {
		AnnotationCmd:59 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.CVLFunctionStart","callIndex":1,"name":"workOnSCVL","range":{"#class":"utils.Range.Range","specFile":"test.spec","start":{"line":24,"charByteOffset":4},"end":{"line":24,"charByteOffset":20}},"isNoRevert":true}}
		AssignExpCmd:60 I13 CANON:29
		AssignExpCmd:59 CANON17:15 I13
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"s296298"},"src":{"id":"s290"}}}
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"s293"},"src":{"id":"s296298"}}}
		AssignExpCmd CANON25:16 CANON9:28
		AssignExpCmd CANON26:17 CANON10:9
		AssignExpCmd CANON27:18 CANON11:10
		AssignExpCmd CANON28:19 CANON12:11
		AssignExpCmd CANON29:20 CANON14:13
		AssignExpCmd CANON30:21 CANON13:12
		AssignExpCmd CANON31:22 CANON15:14
		...
		AssignExpCmd:69 I28 0x0
		AssertCmd:70 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:71 R29:3 Apply(hash_3_keccak:bif Apply(skey_basic:bif 0x40) Apply(skey_basic:bif 0x0) Apply(skey_basic:bif 0x0))
		AssignExpCmd:71 R30:3 Apply(skey_add:bif R29:3 0x1)
		AssignExpCmd:72 R31:3 AnnotationExp(Select(CANON37!!26:73 R30:74 ) JSON{"key":{"name":"tac.storage.access-paths","type":"analysis.storage.StorageAnalysisResult$AccessPaths","erasureStrategy":"Canonical"},"value":{"paths":[{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.MapAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.Root","slot":"0"},"key":{"#class":"vc.data.TACSymbol.Const","value":"0"},"baseSlot":{"#class":"vc.data.TACSymbol.Const","value":"0"},"hashResult":{"#class":"vc.data.TACSymbol.Const","value":"0"}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"36"}}]}})
		AssumeExpCmd Eq(R31:3 0x0 )
		AssignExpCmd:71 B32 false
		AnnotationCmd:71 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.StorageSnippet.DirectStorageLoad","value":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B32","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"displayPath":{"#class":"analysis.storage.DisplayPath.FieldAccess","field":"b1","base":{"#class":"analysis.storage.DisplayPath.MapAccess","key":{"#class":"vc.data.TACSymbol.Const","value":"0"},"keyTyp":{"#class":"tac.TACStorageType.IntegralType","typeLabel":"uint256","numBytes":"20","descriptor":{"#class":"ReflectivePolymorphicSerializer::spec.cvlast.typedescriptors.EVMTypeDescriptor$UIntK","bitwidth":256},"lowerBound":null,"upperBound":null},"base":{"#class":"analysis.storage.DisplayPath.Root","name":"m"}}},"storageType":{"#class":"spec.cvlast.typedescriptors.EVMTypeDescriptor.bool"},"contractInstance":"ce4604a0000000000000000000000001","range":{"specFile":"test.spec","start":{"line":8,"charByteOffset":12},"end":{"line":8,"charByteOffset":32}}}}
		AssignExpCmd:75 I33 CANON17:15
		AssignExpCmd:76 I34 0x3
		AssignExpCmd:77 B35 false
		AssignExpCmd:78 CANON47:25 true
		AnnotationCmd:71 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":22}
		AnnotationCmd:59 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.CVLFunctionEnd","callIndex":1,"name":"workOnSCVL"}}
		AnnotationCmd:59 JSON{"key":{"name":"revert.confluence","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
		LabelCmd:59 "join point of revert handling"
	}
	Block 2_0_0_0_0_0 Succ [] {
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"tmp410411"},"src":{"id":"s290"}}}
		AssignExpCmd:80 B37 CANON14:13
		AnnotationCmd JSON{"key":{"name":"cvl.trace.traversal","type":"spec.CVLCompiler$Companion$TraceMeta$ValueTraversal","erasureStrategy":"Erased"},"value":{"lhs":{"#class":"spec.CVLCompiler.Companion.TraceMeta.ValueIdentity.TACVar","t":{"namePrefix":"B37","tag":{"#class":"tac.Tag.Bool"},"callIndex":0}},"ap":[{"#class":"ReflectivePolymorphicSerializer::spec.CVLCompiler$Companion$TraceMeta$CVLAccessPathStep$Field","f":"b1"}],"base":{"#class":"spec.CVLCompiler.Companion.TraceMeta.ValueIdentity.CVLVar","id":"tmp410411"}}}
		AssertCmd:81 B37 "s.b1"
	}
}
Axioms {
}
