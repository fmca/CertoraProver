TACSymbolTable {
	...
	CANON4!!10:wordmap:4
	tacSCANON0!!17:wordmap:5
	CANON5!!11:wordmap:6
	CANON6!!12:wordmap:7
	CANON7!!13:wordmap:8
	CANON8!!14:wordmap:9
	CANON9!!15:wordmap:10
	CANON9!!37:wordmap:10
	tacTCANON0:wordmap:11
	tacExtcodesize:wordmap:3
	tacContractsCreated!!8:wordmap:12
	tacBalance:wordmap:13
	tacBalance!!4:wordmap:13
	lastStorageCANON1:wordmap:14
	lastStorageCANON2:wordmap:15
	lastStorageCANON3:wordmap:16
	lastStorageCANON4:wordmap:16
	lastStorageCANON5:wordmap:14
	lastStorageCANON6:wordmap:17
	lastStorageCANON7:wordmap:18
	lastStorageCANON8:wordmap:19
	lastStorageCANON9:wordmap:20
	R0:bv256:0
	R5:bv256:21
	R6:bv256:22
	R7:bv256:23
	...
	R16:bv256:26
	R18:bv256:24
	R33:(uninterp) skey:24
	R34:(uninterp) skey:24
	R36:bv256:24
	R40:(uninterp) skey:24
	R41:(uninterp) skey:24
	R42:bv256:24
	...
	CANON54:bool
	CANON55:bool
	tacContractAtCANON1:bv256:21
	tacContractAtCANON2:bv256:22
	tacContractAtCANON3:bv256:23
	tacContractsCreated:wordmap:12
	CANON1:int:46
	CANON2:int:47
	CANON3:wordmap:27
	CANON4:wordmap:4
	...
	tacSCANON0:wordmap:5
	lastStorageCANON10:wordmap:20
	lastStorageCANON11:wordmap:20
	lastStorageCANON12:wordmap:20
	CANON:int:48
}
Program {
	Block 0_0_0_0_0_0 Succ [1_0_0_1_0_1] {
		...
		AssignHavocCmd CANON16:28
		AssumeExpCmd LAnd(Ge(CANON16:28 0x0(int) ) Le(CANON16:28 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON17:29
		AssumeExpCmd LAnd(Ge(CANON17:29 0x0(int) ) Le(CANON17:29 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON18:30
		AssumeExpCmd LAnd(Ge(CANON18:30 0x0(int) ) Le(CANON18:30 0xff(int) ) )
		AssignHavocCmd CANON19:31
		AssumeExpCmd LAnd(Ge(CANON19:31 0x0(int) ) Le(CANON19:31 0xff(int) ) )
		AssignHavocCmd CANON20:32
		AssumeExpCmd LAnd(Ge(CANON20:32 0x0(int) ) Le(CANON20:32 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON21:33
		AssignHavocCmd CANON22:34
		AssignHavocCmd R5:21
		AssumeExpCmd Eq(R5:21 0x1 )
		AssignHavocCmd R6:22
		AssumeExpCmd Eq(R6:22 0x2 )
		AssignHavocCmd R7:23
		AssumeExpCmd Eq(R7:23 0x4 )
		AssignHavocCmd CANON3!!9:27
		AssignHavocCmd CANON4!!10:4
		AssignHavocCmd CANON5!!11:6
		AssignHavocCmd CANON6!!12:7
		AssignHavocCmd CANON7!!13:8
		AssignHavocCmd CANON8!!14:9
		AssignHavocCmd CANON9!!15:10
		AssignHavocCmd R16:26
		AssumeExpCmd LAnd(Ge(R16:26 0x1 ) Le(R16:26 0xffffffffffffffffffffffffffffffffffffffff ) )
		AssignHavocCmd tacSCANON0!!17:5
		...
		AssignExpCmd R18:24 Select(tacExtcodesize!!3:3 Apply(to_skey:bif R16:52) )
		AssumeExpCmd Ge(R18:24 0x1 )
		AssumeExpCmd Eq(R18:57 R0:58 )
		...
		AssignExpCmd B20:24 Eq(Select(tacExtcodesize!!3:3 Apply(skey_basic:bif 0x0) ) 0x0 )
		AssumeCmd B20:24
		...
		AssignExpCmd:71 I21 CANON:48
		AssignExpCmd:72 I22 0x3
		AssignExpCmd:73 B23 true
	...
	Block 1_0_0_1_0_1 Succ [2_0_0_0_0_0] {
		...
		AssignExpCmd:79 I24 CANON:48
		AssignExpCmd:78 CANON24:35 I24
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"s300301"},"src":{"id":"s291"}}}
		...
		AssignExpCmd CANON32:36 CANON16:28
		AssignExpCmd CANON33:37 CANON17:29
		AssignExpCmd CANON34:38 CANON18:30
		AssignExpCmd CANON35:39 CANON19:31
		AssignExpCmd CANON36:40 CANON21:33
		AssignExpCmd CANON37:41 CANON20:32
		AssignExpCmd CANON38:42 CANON22:34
		...
		AssignExpCmd:88 I39 0x0
		AssertCmd:89 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:90 R40:24 Apply(hash_3_keccak:bif Apply(skey_basic:bif 0x40) Apply(skey_basic:bif 0x0) Apply(skey_basic:bif 0x0))
		AssignExpCmd:90 R41:24 Apply(skey_add:bif R40:24 0x1)
		AssignExpCmd:91 R42:24 AnnotationExp(Select(CANON9!!37:92 R41:93 ) JSON{"key":{"name":"tac.storage.access-paths","type":"analysis.storage.StorageAnalysisResult$AccessPaths","erasureStrategy":"Canonical"},"value":{"paths":[{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.MapAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.Root","slot":"0"},"key":{"#class":"vc.data.TACSymbol.Const","value":"0"},"baseSlot":{"#class":"vc.data.TACSymbol.Const","value":"0"},"hashResult":{"#class":"vc.data.TACSymbol.Const","value":"0"}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"36"}}]}})
		AssumeExpCmd Eq(R42:24 0x0 )
		AssignExpCmd:90 B43 false
		AnnotationCmd:90 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.StorageSnippet.DirectStorageLoad","value":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B43","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"displayPath":{"#class":"analysis.storage.DisplayPath.FieldAccess","field":"b1","base":{"#class":"analysis.storage.DisplayPath.MapAccess","key":{"#class":"vc.data.TACSymbol.Const","value":"0"},"keyTyp":{"#class":"tac.TACStorageType.IntegralType","typeLabel":"uint256","numBytes":"20","descriptor":{"#class":"ReflectivePolymorphicSerializer::spec.cvlast.typedescriptors.EVMTypeDescriptor$UIntK","bitwidth":256},"lowerBound":null,"upperBound":null},"base":{"#class":"analysis.storage.DisplayPath.Root","name":"m"}}},"storageType":{"#class":"spec.cvlast.typedescriptors.EVMTypeDescriptor.bool"},"contractInstance":"ce4604a0000000000000000000000001","range":{"specFile":"test.spec","start":{"line":8,"charByteOffset":12},"end":{"line":8,"charByteOffset":32}}}}
		AssignExpCmd:94 I44 CANON24:35
		AssignExpCmd:95 I45 0x3
		AssignExpCmd:96 B46 false
		AssignExpCmd:97 CANON53:45 true
