...
Program {
	Block 0_0_0_0_0_0 Succ [1_0_0_1_0_1] {
		...
		AssumeExpCmd LAnd(Ge(CANON10:19 0x0(int) ) Le(CANON10:19 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON11:20
		AssumeExpCmd LAnd(Ge(CANON11:20 0x0(int) ) Le(CANON11:20 0xff(int) ) )
		AssignHavocCmd CANON12:21
		AssumeExpCmd LAnd(Ge(CANON12:21 0x0(int) ) Le(CANON12:21 0xff(int) ) )
		...
		AssumeExpCmd LAnd(Ge(CANON9:45 0x0(int) ) Le(CANON9:45 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R6:7
		...
		AnnotationCmd:47 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"rule parameters setup"}}
		...
		AnnotationCmd:48 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"Setup"}}
		AnnotationCmd:49 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"multi contract setup"}}
		AssignExpCmd CANON1:43 R6:50
		AnnotationCmd JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":2}
		AnnotationCmd:51 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"contract address vars initialized"}}
		AssignExpCmd CANON2:44 R6:50
		AnnotationCmd JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":3}
		AnnotationCmd:52 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"setup read tracking instrumentation"}}
		AnnotationCmd JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":4}
		AnnotationCmd:53 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"last storage initialize"}}
		...
		AnnotationCmd:54 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"assuming contracts in scene with non-empty bytecode have EXTCODESIZE larger than zero"}}
		AssignExpCmd R7:3 Select(tacExtcodesize!!1:2 Apply(to_skey:bif R6:50) )
		AssumeExpCmd Ge(R7:3 0x1 )
		AssumeExpCmd Eq(R7:55 R0:56 )
		...
		AssignExpCmd B9:3 Eq(Select(tacExtcodesize!!1:2 Apply(skey_basic:bif 0x0) ) 0x0 )
		...
		AssignExpCmd:69 I10:11 CANON:46
		AssignExpCmd:70 I11:12 0x3
		AssignExpCmd:71 B12:8 true
		AnnotationCmd:72 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":18}
	...
	Block 1_0_0_1_0_1 Succ [2_0_0_0_0_0] {
		AnnotationCmd:76 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.CVLFunctionStart","callIndex":1,"name":"workOnSCVL","range":{"#class":"utils.Range.Range","specFile":"test.spec","start":{"line":24,"charByteOffset":4},"end":{"line":24,"charByteOffset":20}},"isNoRevert":true}}
		AssignExpCmd:77 I13:11 CANON:46
		AssignExpCmd:76 CANON17:25 I13:11
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"s300301"},"src":{"id":"s290"}}}
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"s297"},"src":{"id":"s300301"}}}
		AssignExpCmd CANON25:33 CANON9:45
		AssignExpCmd CANON26:34 CANON10:19
		AssignExpCmd CANON27:35 CANON11:20
		AssignExpCmd CANON28:36 CANON12:21
		AssignExpCmd CANON29:37 CANON14:23
		AssignExpCmd CANON30:38 CANON13:22
		AssignExpCmd CANON31:39 CANON15:24
		...
		AssignExpCmd:86 I28:18 0x0
		AssertCmd:87 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:88 R29:3 Apply(hash_3_keccak:bif Apply(skey_basic:bif 0x40) Apply(skey_basic:bif 0x0) Apply(skey_basic:bif 0x0))
		AssignExpCmd:88 R30:3 Apply(skey_add:bif R29:3 0x1)
		AssignExpCmd:89 R31:3 AnnotationExp(Select(CANON37!!26:90 R30:91 ) JSON{"key":{"name":"tac.storage.access-paths","type":"analysis.storage.StorageAnalysisResult$AccessPaths","erasureStrategy":"Canonical"},"value":{"paths":[{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.MapAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.Root","slot":"0"},"key":{"#class":"vc.data.TACSymbol.Const","value":"0"},"baseSlot":{"#class":"vc.data.TACSymbol.Const","value":"0"},"hashResult":{"#class":"vc.data.TACSymbol.Const","value":"0"}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"36"}}]}})
		AssumeExpCmd Eq(R31:3 0x0 )
		AssignExpCmd:88 B32:8 false
		...
		AssignExpCmd:92 I33:11 CANON17:25
		AssignExpCmd:93 I34:12 0x3
		AssignExpCmd:94 B35:8 false
		AssignExpCmd:95 CANON47:42 true
		AnnotationCmd:88 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":22}
		AnnotationCmd:76 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.CVLFunctionEnd","callIndex":1,"name":"workOnSCVL"}}
	...
	Block 2_0_0_0_0_0 Succ [] {
		...
		AnnotationCmd JSON{"key":{"name":"cvl.trace.data.movement","type":"spec.CVLCompiler$Companion$TraceMeta$CVLMovement","erasureStrategy":"Erased"},"value":{"dst":{"id":"tmp342343"},"src":{"id":"s290"}}}
		AssignExpCmd:97 B37:8 CANON14:23
