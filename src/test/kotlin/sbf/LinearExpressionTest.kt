...
class LinearExpressionTest {
    ...
    fun test01() {
        ...
        println("After renaming $x with $y: $e2")
        val e3 = e2.substitute(y, z)
        println("After renaming $y with $z: $e3")
        val e4 = e3.eval(z, ExpressionNum(1))
        println("After evaluating $z with 1: $e4\nOld expressions: $e1\n$e2\n$e3")
    ...
    fun test02() {
        ...
        println("After evaluating $e1 with $x=2, $y=3 $z=3: $e2")
