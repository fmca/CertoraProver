...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssumeExpCmd LAnd(Ge(CANON4:8 0x1(int) ) Le(CANON4:8 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R5:6
		...
		AssignExpCmd:34 I9 CANON4:35
		AssignExpCmd:36 B10:7 false
		AssignExpCmd:37 B11 true
		AssignExpCmd:38 B12 false
		AssertCmd:39 false "a > 0"
	}
}
Axioms {
}
