...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssignExpCmd:43 I14 CANON4:14
		AssignExpCmd:44 I15 CANON5:15
		AssignExpCmd:45 I16 IntAdd(I14 I15)
		AssignExpCmd:46 B17 Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I16 )
		AnnotationCmd:46 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I16","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B17","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":55,"charByteOffset":18},"end":{"line":55,"charByteOffset":32}}}}
		AssertCmd:47 B17 "Cast safety of x + y (mathint) to uint256 (Cast.spec:56:19)"
		AnnotationCmd:46 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
	}
}
Axioms {
}
