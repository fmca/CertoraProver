...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssignExpCmd R11:13 Select(tacExtcodesize!!3:3 Apply(to_skey:bif R9:22) )
		AssumeExpCmd Ge(R11:13 0x1 )
		AssumeExpCmd Eq(R11:26 R0:27 )
		...
		AssignExpCmd:42 I16 IntMul(CANON4:15 CANON4:15)
		AssumeExpCmd Eq(I16 0x9(int) )
		AssignExpCmd:43 I17 0x9
		AssignExpCmd:44 CANON12:14 true
		...
		AssignExpCmd I18 CANON4:15
		AnnotationCmd JSON{"key":{"name":"cvl.trace.traversal","type":"spec.CVLCompiler$Companion$TraceMeta$ValueTraversal","erasureStrategy":"Erased"},"value":{"lhs":{"#class":"spec.CVLCompiler.Companion.TraceMeta.ValueIdentity.TACVar","t":{"namePrefix":"I18","tag":{"#class":"tac.Tag.Int"},"callIndex":0}},"ap":[{"#class":"ReflectivePolymorphicSerializer::spec.CVLCompiler$Companion$TraceMeta$CVLAccessPathStep$ArrayLength"}],"base":{"#class":"spec.CVLCompiler.Companion.TraceMeta.ValueIdentity.CVLVar","id":"tmp178179"}}}
		AssignExpCmd:47 I19 0x2
		AssignExpCmd:48 I20 IntMul(0x2(int) CANON4:15)
		AssignExpCmd:49 I21 0x5
		AssignExpCmd:50 B22 Le(I20 0x5(int) )
		AssertCmd:51 B22 "arr.length * 2 <= 5"
	}
}
Axioms {
}
