...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssignHavocCmd CANON5:8
		AssumeExpCmd LAnd(Ge(CANON5:8 0x0(int) ) Le(CANON5:8 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R5:6
		...
		AssignExpCmd:36 I9 CANON4:7
		AssignExpCmd:37 I10 CANON5:8
		AssignExpCmd:38 I11 IntAdd(I9 I10)
		AssignExpCmd:39 B12 Ge(0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff I11 )
		AnnotationCmd:39 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.CVLSnippetCmd.AssertCast","cvlExpOutSym":{"namePrefix":"I11","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"assertCond":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B12","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"range":{"#class":"utils.Range.Range","specFile":"Cast.spec","start":{"line":55,"charByteOffset":18},"end":{"line":55,"charByteOffset":32}}}}
		AssertCmd:40 B12 "Cast safety of x + y (mathint) to uint256 (Cast.spec:56:19)"
		AnnotationCmd:39 JSON{"key":{"name":"snippet.cmd.scope.end","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}
	}
}
Axioms {
}
